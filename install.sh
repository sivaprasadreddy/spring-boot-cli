...
sbcli_zip_file="${sbcli_archives_folder}/spring-boot-cli-${SBCLI_VERSION}_${ostype}_amd64.zip"
...
ln -sf "$SBCLI_DIR/$SBCLI_VERSION/spring-boot-cli" "$SBCLI_DIR/current/sbcli"
